...
static int32_t s5k3h2yx_poweron_af(void)
{
	...
	rc = ioext_gpio_set_value(s5k3h2yx_msm_actuator_info->vcm_pwd, 1);
#else
...
static void s5k3h2yx_poweroff_af(void)
{
	...
	msleep(1);
#ifdef CONFIG_MACH_MAGNIDS
	rc = ioext_gpio_set_value(s5k3h2yx_msm_actuator_info->vcm_pwd, 0);
#else
	rc = gpio_request(s5k3h2yx_msm_actuator_info->vcm_pwd, "s5k3h2yx");
	if (!rc)
...
int32_t s5k3h2yx_msm_actuator_move_focus(struct msm_actuator_ctrl_t *a_ctrl,
...
{
	LINFO("%s called\n", __func__);
	return (int) msm_actuator_config(&s5k3h2yx_act_t, argp);
}
...
static struct msm_actuator_func_tbl s5k3h2yx_act_func_tbl = {
...
static struct msm_actuator_ctrl_t s5k3h2yx_act_t = {
	...
	.set_info = {
		.af_tuning_params.total_steps = S5K3H2YX_TOTAL_STEPS_NEAR_TO_FAR,
		//.gross_steps = 3,	/*[TBD]*/
		//.fine_steps = 1,	/*[TBD]*/
	},
	...
	.func_tbl = &s5k3h2yx_act_func_tbl,
