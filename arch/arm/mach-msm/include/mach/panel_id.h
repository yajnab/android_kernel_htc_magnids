...
#define PANEL_ID_PROTOU_LG    (0x5C | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_PROTOU_SHARP (0x5D | BL_MIPI | IF_MIPI | DEPTH_RGB888 | MIPI_VIDEO_ONLY)
#define PANEL_ID_PROTOU_SHARP_C1 (0x5D | BL_MIPI | IF_MIPI | DEPTH_RGB888 | REV_1 | MIPI_VIDEO_ONLY)
