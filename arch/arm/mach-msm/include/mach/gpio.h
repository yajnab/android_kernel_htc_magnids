...
/* HTC START */
static inline void gpio_get_value_array(unsigned *gpio, int *value)
{
	__gpio_get_value_array(gpio, value);
}
/* HTC END */
...
/* HTC START */
static inline void gpio_set_value_array(unsigned *gpio, int *value)
{
	__gpio_set_value_array(gpio, value);
}
/* HTC END */
